...
class SDSParser:
    ...
    def __init__(self, request_keys=None, dev=False):
        """
    ...
    @staticmethod
    def get_text_file_path(sds_file_path):
        """
    ...
    def get_stored_sds_text(sds_file_path):
        text_file_path = SDSParser.get_text_file_path(sds_file_path)
        ...
        for request_key in self.request_keys:
            ...
            if request_key in regexes:
                ...
                if request_key == 'manufacturer':
                    sds_data[request_key] = match.lower().title()
                else:
